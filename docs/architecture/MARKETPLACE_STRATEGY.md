...
| 4 | Pending vs available wallet buckets | Shipped | `pending_balance` / `available_balance`, `vendor_balance_holds`, settlement → pending, withdrawals → available, `release-pending-wallet-funds` cron |
