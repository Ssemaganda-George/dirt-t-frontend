...
- [`SECURITY.md`](./SECURITY.md) — short, non-technical (for partners)
- [`SECURITY-ENGINEERING.md`](./SECURITY-ENGINEERING.md) — auth, RLS, paid-state, Edge secrets
- [`MONEY_CYCLE.md`](./MONEY_CYCLE.md) — MarzPay → webhook → wallets / tickets
