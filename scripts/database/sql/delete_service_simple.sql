-- Simple SQL commands to delete service and all related data
...
DELETE FROM public.scan_sessions WHERE service_id = 'b5980e78-d57a-4438-8787-eb92a774c687';

-- Delete review tokens
DELETE FROM public.review_tokens WHERE service_id = 'b5980e78-d57a-4438-8787-eb92a774c687';
