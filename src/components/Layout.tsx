      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white border-r border-slate-200">
          <div className="flex h-14 items-center justify-between px-4 border-b border-slate-100">
            ...
            <button onClick={() => setSidebarOpen(false)} className="p-1.5 rounded-lg hover:bg-slate-100 transition">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2.5">
                            <item.icon className={`h-4 w-4 ${isActive ? 'text-blue-200' : 'text-slate-400'}`} />
                            {t(item.labelKey)}
                          </div>
                          {showMessageBadge && (
          ...
          <div className="flex h-14 items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 border border-slate-200 rounded-lg hover:bg-slate-50 transition text-sm"
                title={t('preferences')}
              >
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {/* Dropdown */}
                {dropdownOpen && (
                  <div className="absolute right-0 mt-1.5 w-52 bg-white rounded-xl shadow-lg border border-slate-200 z-[999] overflow-hidden">
