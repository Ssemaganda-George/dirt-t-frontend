  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow-sm border border-gray-200 p-8 mb-8 rounded-lg">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
            <div className="relative">
              <div className="h-24 w-24 bg-gray-200 flex items-center justify-center text-gray-600 text-3xl font-bold rounded-full">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white shadow-sm border border-gray-200 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <Link
                  to="/bookings"
                  className="bg-gray-50 p-4 rounded-lg text-center border border-gray-200 hover:bg-gray-100 hover:shadow-sm transition-all duration-200 group"
                >
                  <Calendar className="h-6 w-6 text-gray-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                ...
                <Link
                  ...
                  className="bg-gray-50 p-4 rounded-lg text-center border border-gray-200 hover:bg-gray-100 hover:shadow-sm transition-all duration-200 group"
                >
                  <Heart className="h-6 w-6 text-gray-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                ...
                <Link
                  ...
                  className="bg-gray-50 p-4 rounded-lg text-center border border-gray-200 hover:bg-gray-100 hover:shadow-sm transition-all duration-200 group"
                >
                  <div className="h-6 w-6 bg-gray-600 rounded-full flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white shadow-sm border border-gray-200 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:bg-gray-100 hover:shadow-sm transition-all duration-200">
                  <div className="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
                    <div className="flex items-center space-x-4">
                      <div className="h-14 w-14 bg-gray-200 flex items-center justify-center rounded-lg shadow-sm">
              ...
              <div className="mt-6 text-center">
                <Link
                  to="/bookings"
                  className="inline-flex items-center px-6 py-3 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition-colors duration-200 shadow-sm"
                >
