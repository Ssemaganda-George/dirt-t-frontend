    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white shadow-sm border border-gray-200 rounded-2xl p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-3">{t('welcome_to_app')}</h2>
          ...
          <div className="space-y-3">
            ...
            <Link
              to="/vendor-login"
              className="w-full bg-white text-gray-700 py-3 px-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors block font-medium"
            >
              {t('vendor_sign_in')}
            </Link>
          </div>
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow-sm border border-gray-200 p-8 mb-8 rounded-2xl">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white shadow-sm border border-gray-200 p-6 rounded-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <Link
                  to="/bookings"
                  className="bg-gray-50 p-4 rounded-xl text-center border border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 hover:shadow-sm transition-all duration-200 group"
                >
                  <Calendar className="h-6 w-6 text-gray-500 group-hover:text-emerald-700 mx-auto mb-2 group-hover:scale-110 transition-all" />
                ...
                <Link
                  ...
                  className="bg-gray-50 p-4 rounded-xl text-center border border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 hover:shadow-sm transition-all duration-200 group"
                >
                  <Heart className="h-6 w-6 text-gray-500 group-hover:text-emerald-700 mx-auto mb-2 group-hover:scale-110 transition-all" />
                ...
                <Link
                  ...
                  className="bg-gray-50 p-4 rounded-xl text-center border border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 hover:shadow-sm transition-all duration-200 group"
                >
                  <Settings className="h-6 w-6 text-gray-500 group-hover:text-emerald-700 mx-auto mb-2 group-hover:scale-110 transition-all" />
            ...
            <div className="bg-white shadow-sm border border-gray-200 p-6 rounded-2xl">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 hover:border-emerald-200 hover:shadow-sm transition-all duration-200">
