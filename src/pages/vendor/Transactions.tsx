      ...
      <div className="bg-white rounded-xl border border-gray-200 p-1.5 inline-flex gap-1">
        {(['overview', 'transactions', 'recommendations'] as const).map(tab => (
          <button
            ...
            className={`min-h-[36px] px-3 py-1.5 rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 ${
              activeTab === tab ? 'bg-emerald-700 text-white' : 'text-gray-600 hover:bg-gray-100'
            }`}
          >
      ...
      {error && (
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={refresh} className="text-xs font-medium text-gray-600 hover:text-gray-900 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 rounded">Retry</button>
          </div>
        </div>
      )}
                  ...
                  <div className="mb-6 md:mb-8 bg-white shadow rounded-lg p-4 md:p-6">
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                      ...
                      <button
                        ...
                        className="text-sm text-gray-700 hover:text-gray-900 self-start sm:self-auto transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 rounded"
                      >
                        Clear Filters
                      </button>
                    </div>
          ...
          <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-xl max-w-md w-full">
              <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                ...
                <button onClick={() => setShowWithdraw(false)} className="min-h-[36px] min-w-[36px] rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600 text-lg transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20">✕</button>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full min-h-[40px] border border-gray-200 rounded-lg px-3 py-2 pr-16 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20"
                      placeholder="0.00"
                    />
                 ...
                 <div>
                   ...
                   {payoutOptions.length === 0 ? (
                     <div className="text-sm text-gray-700 bg-gray-50 border border-gray-200 rounded-lg p-3">
                       ...
                       <p className="mt-1 text-gray-600">Please add a bank or mobile-money account in your profile before requesting a withdrawal.</p>
                       <button
                    ...
                    <select
                      ...
                      className="w-full min-h-[40px] border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20"
                    >
