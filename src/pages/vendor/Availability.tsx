  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-6" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <select
          className="w-full sm:w-auto border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600"
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-xl shadow-xl overflow-y-auto max-h-[85vh]">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10">
              ...
              <button onClick={() => setSelectedBookingObj(null)} className="p-1.5 rounded-lg hover:bg-gray-100 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20">
                <X className="w-4 h-4 text-gray-500" />
              </button>
            </div>
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="flex justify-end pt-2">
                <button onClick={() => setSelectedBookingObj(null)} className="px-4 py-2 bg-emerald-700 text-white text-sm rounded-lg hover:bg-emerald-800 transition">
                  Close
                </button>
              </div>
            </div>
