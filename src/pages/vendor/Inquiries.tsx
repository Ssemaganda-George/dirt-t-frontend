                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  {inquiry.status === 'unread' && (
                    <button
                      ...
                      className="text-xs font-medium text-gray-700 hover:underline transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 rounded"
                    >
                      Mark Read
                    </button>
                  )}
                  {inquiry.status === 'read' && (
                    <button
                      ...
                      className="text-xs font-medium text-gray-900 hover:underline transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 rounded"
                    >
                      Respond
                    </button>
                  )}
                  {inquiry.status !== 'archived' && (
                    <button
                      ...
                      className="text-xs font-medium text-gray-400 hover:text-gray-600 hover:underline transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 rounded"
                    >
                      Archive
                    </button>
                  )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-xl shadow-xl overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
              ...
              <button onClick={() => setSelectedInquiry(null)} className="p-1.5 rounded-lg hover:bg-gray-100 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20">
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 resize-none"
              ...
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className="min-h-[40px] px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 rounded-lg transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={responding}
                  className="min-h-[40px] px-4 py-2 text-sm font-medium text-white bg-emerald-700 rounded-lg hover:bg-emerald-800 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/20 disabled:opacity-50 disabled:cursor-not-allowed"
                >
