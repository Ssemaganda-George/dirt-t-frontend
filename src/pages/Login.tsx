        ...
        <div className="px-6 pb-6 pt-3">
          ...
          {!showEmailForm && !isSignUp ? (
            <div className="space-y-2">
              ...
              {/* compact landing - legal line moved to persistent footer */}
              ...
              <button
                ...
                className="w-full min-h-[44px] flex items-center justify-center gap-3 px-3 py-2 rounded-lg bg-gray-900 text-sm font-medium text-white hover:bg-gray-800 transition-all duration-150"
              >
              ...
              <p className="text-center text-sm text-gray-500 pt-2">
                <button onClick={() => { setIsSignUp(true); setShowEmailForm(false) }} className="text-gray-900 font-medium">Sign up</button>
              </p>

              {/* removed legal text for compact dialog */}
            </div>
