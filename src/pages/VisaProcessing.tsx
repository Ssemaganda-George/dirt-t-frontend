        ...
        <div className="bg-white shadow-sm border border-gray-200 p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-gray-200 p-8">
              ...
              <p className="text-3xl font-black text-black">$200<span className="text-lg font-normal text-gray-600">/visa</span></p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700 font-medium">+256 759 918649</span>
                </div>
                <div className="flex items-center">
