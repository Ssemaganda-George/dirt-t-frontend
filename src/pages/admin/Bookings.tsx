    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 xl:grid-cols-8 gap-3">
        ...
        <div 
          ...
          className={`bg-white rounded-xl border p-4 hover:shadow-sm transition-all cursor-pointer ${selectedStatusFilter === 'pending' ? 'border-amber-500 ring-2 ring-amber-100' : 'border-gray-200 border-l-4 border-l-amber-500'}`}
        >
        ...
        <div 
          ...
          className={`bg-white rounded-xl border p-4 hover:shadow-sm transition-all cursor-pointer ${selectedStatusFilter === 'confirmed' ? 'border-blue-500 ring-2 ring-blue-100' : 'border-gray-200 border-l-4 border-l-blue-500'}`}
        >
        ...
        <div 
          ...
          className={`bg-white rounded-xl border p-4 hover:shadow-sm transition-all cursor-pointer ${selectedStatusFilter === 'completed' ? 'border-emerald-500 ring-2 ring-emerald-100' : 'border-gray-200 border-l-4 border-l-emerald-500'}`}
        >
        ...
        <div 
          ...
          className={`bg-white rounded-xl border p-4 hover:shadow-sm transition-all cursor-pointer ${selectedStatusFilter === 'cancelled' ? 'border-red-500 ring-2 ring-red-100' : 'border-gray-200 border-l-4 border-l-red-500'}`}
        >
        ...
        <div 
          ...
          className="bg-white rounded-xl border border-gray-200 border-l-4 border-l-purple-500 p-4 hover:shadow-sm transition-all cursor-pointer"
        >
        ...
        <div 
          ...
          className="bg-white rounded-xl border border-gray-200 border-l-4 border-l-gray-500 p-4 hover:shadow-sm transition-all cursor-pointer"
        >
