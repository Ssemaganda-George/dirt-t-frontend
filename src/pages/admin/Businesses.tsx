                  ...
                  {user.profile.role === 'vendor' && user.vendor && (
                    <>
                      <button
                        ...
                        className="text-purple-600 hover:text-purple-900 p-2 rounded-full bg-purple-50 hover:bg-purple-100 transition"
                        title="Assign Tier"
                      >
                      ...
                      {user.vendor.manual_tier_id && (
                        <button
                          ...
                          className="text-orange-600 hover:text-orange-900 p-2 rounded-full bg-orange-50 hover:bg-orange-100 transition"
