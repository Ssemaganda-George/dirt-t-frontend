...
export function FlightsBookings() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>('cat_flights') // Pre-filtered to flights
  ...
  useEffect(() => {
    ...
    if (!searchQuery.trim()) {
      ...
      if (selectedVendor === 'all' && selectedCategory === 'cat_flights') {
  ...
  } else if (selectedCategory === 'cat_flights') {
    // Filter to only show flights bookings by default
    displayBookings = bookings.filter(booking =>
      booking.service?.service_categories?.name?.toLowerCase() === 'flights' ||
      booking.service?.category_id === 'cat_flights'
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">Flights Bookings Management</h1>
      ...
      <div className="bg-white shadow rounded-lg p-4">
        <SearchBar
          placeholder="Search flights bookings by service, customer, or booking ID..."
      ...
      <div className="bg-white shadow rounded-lg p-4">
        ...
        <div className="flex space-x-3 overflow-x-auto pb-2">
          ...
          >
            <div className="text-sm font-medium truncate" style={{maxWidth: 220}}>Flights</div>
          </button>
        </div>
      </div>
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-900">Flight Booking Details</h3>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p><span className="font-medium">Departure Time:</span> {selectedBooking.service?.departure_time ? formatDateTime(selectedBooking.service?.departure_time) : 'N/A'}</p>
