  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">Shops Bookings Management</h1>
      ...
      <div className="bg-white shadow rounded-lg p-4">
        ...
        <div className="flex space-x-3 overflow-x-auto pb-2">
          ...
          >
            <div className="text-sm font-medium truncate" style={{maxWidth: 220}}>Shops</div>
          </button>
        </div>
      </div>
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-900">Shop Booking Details</h3>
                <button
