...
export function EventsBookings() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>('cat_activities') // Default to activities
  ...
  useEffect(() => {
    ...
    if (!searchQuery.trim()) {
      ...
      if (selectedVendor === 'all' && selectedCategory === 'cat_activities') {
  ...
  if (filteredBookings !== null) {
    ...
    // Filter to only show activities bookings by default
    displayBookings = bookings.filter(booking =>
      booking.service?.service_categories?.name?.toLowerCase() === 'activities' ||
      booking.service?.category_id === 'cat_activities'
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Events Bookings Management</h1>
          <p className="text-sm text-slate-500 mt-1">Manage and track all event bookings</p>
        </div>
      ...
      <div className="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
        <div className="border-b border-slate-100 px-5 py-3">
          <h3 className="text-sm font-semibold text-slate-900">All Event Bookings</h3>
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-xl rounded-xl bg-white">
            <div className="mt-3">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-sm font-semibold text-slate-900">Event Booking Details</h3>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <h4 className="font-medium text-slate-900 mb-2">Event Service</h4>
                  <div className="space-y-2 text-sm">
                    ...
                    <p><span className="font-medium">Event Date:</span> {selectedBooking.service?.event_date ? formatDateTime(selectedBooking.service?.event_date) : 'N/A'}</p>
