    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Monitor platform-wide financial activity</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-blue-200 p-4 hover:shadow-sm transition-all">
          ...
          <p className="text-2xl font-semibold text-slate-900 mt-2">{stats.payments}</p>
        ...
        <div className="bg-white rounded-xl border border-violet-200 p-4 hover:shadow-sm transition-all">
          ...
          <p className="text-2xl font-semibold text-slate-900 mt-2">{stats.withdrawals}</p>
        ...
        <div className="bg-white rounded-xl border border-amber-200 p-4 hover:shadow-sm transition-all">
          ...
          <p className="text-2xl font-semibold text-slate-900 mt-2">{stats.refunds}</p>
      ...
      <div className="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
        <div className="border-b border-slate-100 px-5 py-3">
          ...
          <p className="text-xs text-slate-500 mt-0.5">All platform financial activity</p>
        </div>
        <div className="p-5">
                    ...
                    {selectedTransaction.payout_meta ? (
                      selectedTransaction.payout_meta.type === 'bank' ? (
                        <div>
                          ...
                          <div className="text-sm text-slate-600">Branch: {selectedTransaction.payout_meta.branch || '—'}</div>
                          <div className="mt-3">
                            <button
