      ...
      <div className="space-y-6">
        ...
        <div className="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
          <div className="border-b border-slate-100 px-5 py-3">
            <h3 className="text-sm font-semibold text-slate-900">Tours Management</h3>
          </div>
          <div className="p-5">
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Tours Management</h1>
          <p className="text-sm text-slate-500 mt-1">Manage and review all tour services</p>
        </div>
      ...
      <div className="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
        <div className="border-b border-slate-100 px-5 py-3">
          <h3 className="text-sm font-semibold text-slate-900">All Tours</h3>
          <p className="text-xs text-slate-500 mt-0.5">{filteredServices.length} tours found</p>
        </div>
        <div className="p-5">
      ...
      {filteredPendingServices.length > 0 && (
        <div className="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
          <div className="border-b border-slate-100 px-5 py-3">
            ...
            <p className="text-xs text-slate-500 mt-0.5">{filteredPendingServices.length} tours awaiting review</p>
          </div>
          <div className="p-5">
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-slate-200">
